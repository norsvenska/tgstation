/datum/language/norse
	name = "Rymdnordisk"
	desc = "The official language of the Nordic Fleet. A hybrid between the three Scandinavian languages as well as a little bit of German."
	key = "s" //sea people
	space_chance = 15
	syllables = list(
		list(
		...
		list(
			...
			"om", "or", "ör", "ra", "re", "sk", "st", "ta", "te", "ti", "tt", "va",
			"ade", "all", "and", "ans", "ara", "att", "den", "der", "det", "era",
		...
		list(
			...
			"nn", "og", "om", "or", "re", "se", "st", "te", "ti", "tt", "ve", "vi",
			"all", "ans", "are", "dde", "den", "der", "det", "ell", "end", "ene",
			"enn", "ent", "ere", "ett", "for", "gen", "had", "han", "hen", "ikk",
			"ing", "itt", "jeg", "kan", "kke", "ler", "lig", "lle", "med", "men",
			"mme", "nde", "nge", "nne", "ren", "som", "ste", "ten", "til", "tte",
			"var", "ver", "vis"
		) // from https://www.sttmedia.com/syllablefrequency-norwegian
	)
	icon_state = "norse"
	default_priority = 90
